...
import defaultClasses from '@magento/pagebuilder/lib/ContentTypes/Slider/slider.module.css';
import { useStyle } from '@magento/venia-ui/lib/classify';
import { useMediaQuery } from '@magento/peregrine/lib/hooks/useMediaQuery';
import customClasses from './slider.module.css';
...
const Slider = props => {
    ...
    const sliderSettings = {
        autoplay: autoplay
            ? { delay: autoplaySpeed ? autoplaySpeed : 5000 }
            : false,
    ...
    return (
        <div
            aria-live="polite"
            aria-busy="false"
            className={[classes.root, ...cssClasses, classes.swiperWrapper].join(' ')}
            style={{ ...dynamicStyles, ...mediaQueryStyles }}
        >
            <Swiper className={classes.swiper} {...sliderSettings}>
